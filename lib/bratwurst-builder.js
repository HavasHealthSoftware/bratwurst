...
BratwurstBuilder.prototype.__proto__ = EventEmitter.prototype;
	...
	function renderFiles(jsonFiles) {
		...
		for (var jsonFile in jsonFiles) {
			...
			if (fs.existsSync(htmlFilePath)) {
				winston.debug('File %s exists, processing template', htmlFilePath);
				...
				winston.debug('File %s does not exist ignoring', htmlFilePath);
			}
